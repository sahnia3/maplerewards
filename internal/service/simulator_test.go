...
func (m *mockSimCard) GetMultiplierForCard(_ context.Context, cardID, categoryID string) (*model.CardMultiplier, error) {
...
func (m *mockSimCard) GetEverythingElseMultiplier(_ context.Context, cardID string) (*model.CardMultiplier, error) {
