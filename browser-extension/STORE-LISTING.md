...
>
> What it does:
> • Reads your wallet from your Maple Rewards account (sign in once at maplerewards.ca).
...
>
> The full Maple Rewards web app at maplerewards.ca lives alongside the extension — including missed-rewards forensics, a Pro AI assistant, the Aeroplan SQC tracker, and a card-application cooldown tracker.
>
> ## Privacy
> • The extension only reads cookies from maplerewards.ca to identify you. It does NOT read cookies from any retailer site.
> • No data is sold or shared with advertisers.
> • Full privacy policy: https://maplerewards.ca/privacy
>
> ## Support
> • Issues: hello@maplerewards.ca
...
| Why `cookies` permission? | "Read the `mr_session` cookie from maplerewards.ca to authenticate the user's wallet request. We do NOT read cookies from any retailer." |
...
| Is data transmitted off-device? | "Yes — to the MapleRewards backend at maplerewards.ca over HTTPS, for the sole purpose of returning the best-card recommendation." |
...
- **5 screenshots (1280×800 each)** to capture before submitting:
  ...
  4. Empty-state popup ("Sign in to maplerewards.ca").
...
- [ ] Listed support email matches the privacy policy contact (hello@maplerewards.ca)
